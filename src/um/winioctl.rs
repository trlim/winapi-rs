...
use shared::minwindef::{DWORD, BYTE, WORD};
use um::winnt::{LARGE_INTEGER, WCHAR, HANDLE, FILE_READ_DATA, FILE_WRITE_DATA, ANYSIZE_ARRAY};
...
DEFINE_DEVPROPKEY!(DEVPKEY_Storage_Portable,
    0x4d1ebee8, 0x803, 0x4774, 0x98, 0x42, 0xb7, 0x7d, 0xb5, 0x2, 0x65, 0xe9, 2);    // DEVPROP_TYPE_BOOLEAN
DEFINE_DEVPROPKEY!(DEVPKEY_Storage_Removable_Media,
    0x4d1ebee8, 0x803, 0x4774, 0x98, 0x42, 0xb7, 0x7d, 0xb5, 0x2, 0x65, 0xe9, 3);    // DEVPROP_TYPE_BOOLEAN
DEFINE_DEVPROPKEY!(DEVPKEY_Storage_System_Critical,
    0x4d1ebee8, 0x803, 0x4774, 0x98, 0x42, 0xb7, 0x7d, 0xb5, 0x2, 0x65, 0xe9, 4);    // DEVPROP_TYPE_BOOLEAN
